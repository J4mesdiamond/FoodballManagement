...
const Active = () => {
  ...
  //ID for Update record and Delete
    ...
    const hanldeSubmit = () =>{
        const url = 'http://localhost:5000/activity'
        const Credentias =  {fixtures, team, date}
    ...
    const hanldeEdit = () =>{
        ...
        const Credentials =  {fixtures, team, date}
                    ...
                    <Modal.Body>
                        <div>
                            <div className="form-group">
                                <input type="text" className='form-control' value={RowData.fixtures} readOnly />
                            </div>
                            <div className="form-group">
            ...
            <div className="model-box-view" style={{}}>
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            <div className="form-group">
                                <input type="text" className='form-control' onChange={(e) => setFixtures(e.target.value)} placeholder="Please Enter Fixtures"/>
                            </div>
                            <div className="form-group">
                    ...
                    <Modal.Body>
                        <div>
                            <div className="form-group">
                                ...
                                <input type="text" className='form-control' onChange={(e) => setFixtures(e.target.value)} placeholder="Please Enter Fixture" defaultValue={RowData.staffName}/>
                            </div>
                            <div className="form-group">
                                <label>Team</label>
