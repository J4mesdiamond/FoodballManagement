...
const Result = () => {
  ...
  //ID for Update record and Delete
    ...
    const hanldeSubmit = () =>{
        const url = 'http://localhost:5000/result'
        const Credentias =  {score, team, date}
    ...
    //Edit Employees
    const hanldeEdit = () =>{
        const url = `http://localhost:5000/result/${id}`
        const Credentials =  {score, team, date}
                    ...
                    <Modal.Body>
                        <div>
                            <div className="form-group">
                                <input type="text" className='form-control' value={RowData.score} readOnly />
                            </div>
                            <div className="form-group">
            ...
            <div className="model-box-view" style={{}}>
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            <div className="form-group">
                                <input type="text" className='form-control' onChange={(e) => setScore(e.target.value)} placeholder="Please Enter Score"/>
                            </div>
                            <div className="form-group">
                                <input type="text" className='form-control'  onChange={(e) => setTeam(e.target.value)} placeholder="Please Enter Team"/>
                            </div>
                            <div className="form-group">
                                <input type="text" className='form-control'  onChange={(e) => setDate(e.target.value)} placeholder="Please Enter Date" />
                            </div>
                    ...
                    <Modal.Body>
                        <div>
                            <div className="form-group">
                                ...
                                <input type="text" className='form-control' onChange={(e) => setScore(e.target.value)} placeholder="Please Enter Score" defaultValue={RowData.staffName}/>
                            </div>
                            <div className="form-group">
                                <label>Team</label>
                            ...
                            <div className="form-group">
                                <label>Date</label>
                                <input type="text" className='form-control'  onChange={(e) => setDate(e.target.value)} placeholder="Please Enter Level" defaultValue={RowData.level}/>
                            </div>
